 ...
 */
class SmppSms extends SmppProtocol\SmppPdu {
     ...
     */
    public function __construct($id, $status, $sequence, $body, $service_type, SmppProtocol\SmppAddress $source, SmppProtocol\SmppAddress $destination, $esmClass, $protocolId, $priorityFlag, $registeredDelivery, $dataCoding, $message, $tags, $scheduleDeliveryTime = null, $validityPeriod = null, $smDefaultMsgId = null, $replaceIfPresentFlag = null) {
